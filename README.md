...
教師發佈後，家長會在班群看到「開啟並填寫」按鈕。表單以手機逐題方式呈現，提供進度、上一步／下一步與最後的答案確認，再送出回覆。每位家長只有一份回覆紀錄，重新送出會更新自己的同一份內容；教師可看到已回覆／未回覆人數、名單與各份答案。表單連結會檢查既有登入身分，自動帶入座號與姓名。教師可「收回表單」：班群公告會顯示訊息已收回，家長停止填寫，既有回覆則保留供教師查看；刪除表單才會一併永久刪除所有回覆。
